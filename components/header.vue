            ...
            <router-link to="/">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="99" height="20" viewBox="0 0 99 20">
                    <g fill="none" fill-rule="evenodd">
                        <path fill="#FEFEFE" d="M2.947 5.828c.052-.214.191-.47.603-1.332C4.655 2.292 6.585.911 9.338.354c.352-.087.475-.076.81-.076h.463V2.14h-.463c-.644 0-1.454.241-2.431.722-.669.33-1.28.836-1.833 1.52-.553.684-.932 1.406-1.138 2.166l-.154.532h2.47v1.9H4.552V20h-1.89V8.98H0v-1.9h2.624"/>
