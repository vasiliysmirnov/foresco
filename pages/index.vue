...
$('.pressBtn')
  ...
  .mousedown(function() {
    ...
    TweenLite.to("#logoBig", 4.5, {
      transform:'scale(40) translate(15px, 2px)', ease: Power4.easeIn, force3D:false,
      onComplete: function() {
        $nuxt.$router.push('projects')
      }
    });
